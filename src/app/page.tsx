    ...
    <BagossScope>
      ...
      >
        ...
        <div
          ...
          id="hero-text"
        >
          <h1 className="text-[clamp(2.35rem,8.5vw,6rem)] lg:text-[clamp(2.5rem,5.5vw,4.75rem)] xl:text-[5rem] font-extrabold leading-[1.12] text-svs-ink max-w-[320px] sm:max-w-[480px] md:max-w-[700px] lg:max-w-[720px] tracking-tight mb-5 sm:mb-5 md:mb-6">
            Cravings, sorted.
          </h1>

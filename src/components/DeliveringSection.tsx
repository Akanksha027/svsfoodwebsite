    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 md:gap-12 items-start mb-12 sm:mb-16 md:mb-24">
          <div className="relative w-full aspect-[4/5] sm:aspect-[3/4] md:aspect-[4/5] max-h-[min(70vw,420px)] sm:max-h-[480px] md:max-h-none rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-lg">
            <Image
          ...
          <div className="flex flex-col gap-5 sm:gap-8 md:gap-12">
            <div className="relative w-full aspect-[4/3] max-h-[min(55vw,320px)] sm:max-h-[380px] md:max-h-none rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-lg">
              <Image

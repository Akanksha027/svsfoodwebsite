    ...
    <section className="w-full bg-svs-white py-10 sm:py-14 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 font-sans overflow-hidden">
      <div className="w-full max-w-[1500px] mx-auto flex flex-col gap-8 sm:gap-10 md:gap-12">
        ...
        <div className="text-center flex flex-col items-center gap-3 sm:gap-4 px-1">
          <h2 className="text-[1.75rem] sm:text-3xl md:text-4xl lg:text-5xl font-black text-svs-ink tracking-tight leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 lg:gap-8 w-full">
          ...
          <div
            ref={card1Ref}
            className="relative w-full min-h-[360px] sm:min-h-[400px] md:min-h-[460px] lg:min-h-[589px] rounded-[1.5rem] sm:rounded-[2rem] bg-svs-orange text-white p-5 sm:p-8 md:p-12 flex flex-col overflow-hidden shadow-sm"
          >
            <div className="relative z-10 flex flex-col gap-4 sm:gap-6 lg:gap-8 pb-28 sm:pb-36">
              ...
              <div className="mt-2 sm:mt-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 pr-0 sm:pr-4">
                <button className="bg-svs-white text-svs-ink font-bold py-2.5 sm:py-3 px-5 sm:px-6 rounded-full text-sm hover:bg-svs-cream transition-colors shadow-sm">
                  Order Now
                </button>
          ...
          <div
            ref={card2Ref}
            className="relative w-full min-h-[360px] sm:min-h-[400px] md:min-h-[460px] lg:min-h-[589px] rounded-[1.5rem] sm:rounded-[2rem] bg-svs-yellow text-svs-ink p-5 sm:p-8 md:p-12 flex flex-col overflow-hidden shadow-sm"
          >
            <div className="relative z-10 flex flex-col gap-4 sm:gap-6 lg:gap-8 pb-28 sm:pb-36">
              <h3 className="text-2xl sm:text-3xl font-black tracking-wide">
                Cheese Lovers Pair
        ...
        <div
          ref={card3Ref}
          className="relative w-full min-h-[380px] sm:min-h-[440px] md:min-h-[560px] lg:min-h-[828px] mx-auto rounded-[1.5rem] sm:rounded-[2rem] bg-svs-ink text-white p-5 sm:p-8 md:p-10 lg:p-20 flex flex-col overflow-hidden shadow-sm"
        >
          <div className="relative z-10 flex flex-col gap-4 sm:gap-6 lg:gap-10 w-full pb-32 sm:pb-40 md:pb-48">
            ...
            <ul className="flex flex-col gap-2 sm:gap-4 ml-5 list-disc text-base sm:text-lg lg:text-2xl font-medium text-white/80 max-w-[800px]">
            ...
            <div className="mt-2 sm:mt-4 lg:mt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6 w-full">
              <button className="bg-svs-white text-svs-ink font-bold py-3 sm:py-4 px-8 sm:px-10 rounded-full text-sm sm:text-base lg:text-lg hover:bg-svs-cream transition-colors shadow-sm w-fit">
                Order Now
              </button>
